...
namespace Arg.DataModels.DriveHelpers
{
    public class DriveHelper
    {
        public static DriveService _driveService = new DriveService(new BaseClientService.Initializer
        {
            HttpClientInitializer = SharedHelpers.SharedHelper.UserCredential,
            ApplicationName = SharedHelpers.SharedHelper.ApplicationName
        });
