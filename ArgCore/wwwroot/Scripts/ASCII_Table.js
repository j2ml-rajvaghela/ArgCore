function CreateTable(inputText) {
    // set up the style
    var cTL, cTM, cTR;
    var cML, cMM, cMR;
    var cBL, cBM, cBR;
    ...
    var headerStyle = "mysql";
    var autoFormat = true;//$('#auto-format').is(':checked');
    var hasHeaders = true;
    ...
    var style = "mysql";
	var hasLineSeparators = true; // Defaults to no separator lines btwn data rows
